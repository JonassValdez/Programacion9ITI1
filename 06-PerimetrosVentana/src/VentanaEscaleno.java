...
private Operaciones op = new Operaciones();
	...
	public VentanaEscaleno(){
		super.setTitle("Triángulo Escaleno");
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = op.ptEscaleno(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()), Double.parseDouble(txtN3.getText()));
