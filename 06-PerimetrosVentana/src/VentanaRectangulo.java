...
private Operaciones op = new Operaciones();
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = op.perimetroRectangulo(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()));
		lbResultado.setText(String.format("El perimetro del rectangulo es de: %f", r)); 		
	}
