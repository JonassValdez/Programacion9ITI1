...
public VentanaCirculo(){
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		double r = Circulo.perimetro( Double.parseDouble(txtN1.getText()));
		lbResultado.setText(String.format("El perímetro del círculo es: %f" ,r)); 		
		}
		
		if(arg0.getSource()==btnArea){
			
			double r = Circulo.area(Double.parseDouble(txtN1.getText()));
			lbResultado.setText(String.format("El area del círculo es: %f" ,r)); 		
			}
	}
}
