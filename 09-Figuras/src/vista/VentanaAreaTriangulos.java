 ...
 *
 */
public class VentanaAreaTriangulos extends JFrame implements ActionListener {
	...
	private JButton btnCalcular= new JButton("Área");
	private Container c= getContentPane();
	
public VentanaAreaTriangulos(){
		super.setTitle("Área de Triángulos");
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = Triangulos.area(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()));
		lbResultado.setText(String.format("El área del triángulo es de: %f", r)); 		
	}
