...
private Operaciones op = new Operaciones();
	...
	public void actionPerformed(ActionEvent arg0) {
		double r = op.rectangulo(Double.parseDouble(txtN1.getText()), Double.parseDouble(txtN2.getText()));
		lbResultado.setText(String.format("El área del rectangulo es de: %f", r)); 		
	}
